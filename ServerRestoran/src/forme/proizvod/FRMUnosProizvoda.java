...
public class FRMUnosProizvoda extends JFrame {
	...
	public FRMUnosProizvoda() {
		...
		jlKolicina.setBounds(20, 83, 46, 14);
		...
		jtfNazivProizvoda.setBounds(76, 30, 185, 20);
		...
		jbtSacuvaj.setBounds(20, 239, 89, 23);
		contentPane.add(jbtSacuvaj);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(76, 133, 185, 93);
	...
	public void sacuvajProizvod() {
		...
		p.setProizvodID(Kontroler.getInstance().vratiIDProizvoda());
